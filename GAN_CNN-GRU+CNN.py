...
def make_generator_model(input_dim, output_dim, feature_size) -> tf.keras.models.Model:
    ...
    model = Sequential()
    model.add(GRU(units=1024, input_shape=(input_dim, feature_size), return_sequences = True,recurrent_dropout=0.2))
...
class GAN:
    ...
    def train(self, real_x, real_y, yc, opt):
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % 15 == 0:
                tf.keras.models.save_model(generator, 'genCNN-GRU_model_3_1_%d.h5' % epoch)
