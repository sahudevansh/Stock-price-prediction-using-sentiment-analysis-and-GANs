...
from tensorflow.keras.layers import GRU, Dense, Flatten, Conv1D, BatchNormalization, LeakyReLU, ELU, ReLU, Bidirectional
...
def Generator(input_dim, output_dim, feature_size) -> tf.keras.models.Model:
    model = Sequential()
    model.add(Conv1D(128, input_shape=(input_dim, feature_size), kernel_size=3, strides=2, padding="same", activation=LeakyReLU(alpha=0.01)))
    ...
    def train_step(self, data):
        ...
        for _ in range(1):
            with tf.GradientTape() as d_tape:
                ...
                # print('generated data reshape: ', generated_data_reshape.shape)
